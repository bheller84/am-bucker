...
Logstash.prototype.log = function (time, level, module, data, tags, client_ip) {
    var packet = {};
    var name = module || this.name;
    var source = this.source || name;
    var client_ip = this.client_ip || name;
    ...
    packet['@message'] = data;
    packet['@client_ip'] = client_ip || '';

    this.send(packet);
};

Logstash.prototype.access = function (module, data, tags,client_ip) {
    var packet = {};
    var name = module || this.name;
    var source = this.source || name;
    var client_ip = this.client_ip || name;
...
Logstash.prototype.exception = function (time, module, err, tags, client_ip) {
    var packet = {};
    var name = module || this.name;
    var source = this.source || name;
    var client_ip = this.client_ip || name;
